...
**Method**: GPT-4o via the OpenAI API, generated offline (the merged corpus is committed under `data/synthetic/`)
...
**Method**: template-based generation (pure Python, no LLM)
...
After building our evaluation harness, we discovered 48 synthetic tickets with wrong category labels. These were generated by GPT-4o, Claude, and the noise generator with incorrect category assignments. Examples:
